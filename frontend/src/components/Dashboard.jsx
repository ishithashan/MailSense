...
function WorkflowDiagram() {
  const steps = [
    {
      ...
      desc: "Automation fetches emails from Gmail",
      bg: "#EDE9FE", color: "#6C3BFF",
      icon: '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 8l10 7 10-7"/>'
    },
    {
      num: "2. Rule-Based Model",
      desc: "Matches emails with predefined rules",
      bg: "#D1FAE5", color: "#10B981",
      icon: '<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>'
    },
    {
      num: "3. Naive Bayes Model",
      desc: "Classifies using ML (Naive Bayes)",
      bg: "#DBEAFE", color: "#3B82F6",
      icon: '<path d="M12 2a8 8 0 0 1 8 8c0 5.25-8 13-8 13S4 15.25 4 10a8 8 0 0 1 8-8z"/><circle cx="12" cy="10" r="3"/>'
    },
    {
      num: "4. Classified Emails",
      desc: "Emails are categorized with priority",
      bg: "#FEF3C7", color: "#F59E0B",
      icon: '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 8l10 7 10-7"/><path d="M16 18l2 2 4-4" strokeWidth="2.5"/>'
    },
    {
      num: "5. Dashboard View",
      desc: "Displayed in dashboard for easy management",
  ...
  return (
    <div className="workflow-section">
      <div className="workflow-title">RECMails Workflow</div>
      <div className="workflow-steps">
        {steps.map((step, i) => (
          <>
            <div key={step.num} className="workflow-step">
              <div className="step-icon-wrap" style={{ background: step.bg }}>
                <svg viewBox="0 0 24 24" fill="none" stroke={step.color} strokeWidth="2"
            ...
            {i < steps.length - 1 && (
              <div key={`arrow-${i}`} className={`workflow-arrow${i === 1 ? " no-match" : ""}`}>
                {i === 1 && <span>No Match</span>}
